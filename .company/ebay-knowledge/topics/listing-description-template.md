...
| `{{rank_label}}` | ランク英語ラベル | `Excellent` / `New (Opened)` |
...
<div class="mh-wrap {{mode_class}}">
  ...
  <div class="mh-aside">
    ...
    <div class="mh-rankdef">
      ...
      <table>
        <tr><td>N</td><td>New &mdash; Brand new, factory sealed</td></tr>
        <tr><td>S</td><td>New (Opened) &mdash; Opened but unused, no visible wear</td></tr>
